...
class SLPF(unittest.TestCase):
    ...
    def test_deny1c(self):
        self.assertEqual(self.tc.encode("OpenC2-Command", self.mdeny1c), self.mdeny1c)
        self.assertEqual(self.tc.decode("OpenC2-Command", self.mdeny1c), self.mdeny1c)
    ...
    def test_deny3c(self):
        self.assertEqual(self.tc.encode("OpenC2-Command", self.mdeny3), self.mdeny3)
        self.assertEqual(self.tc.decode("OpenC2-Command", self.mdeny3), self.mdeny3)

    def test_deny4c(self):
        self.assertEqual(self.tc.encode("OpenC2-Command", self.mdeny4c), self.mdeny4c)
        self.assertEqual(self.tc.decode("OpenC2-Command", self.mdeny4c), self.mdeny4c)
