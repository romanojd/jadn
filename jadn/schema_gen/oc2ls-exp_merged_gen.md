<!-- Generated from schema\oc2ls-exp_merged.jadn, Tue Dec  4 16:45:08 2018-->
## Schema
| . | . |
| ---: | :--- |
...
| ID | Name | Type | # | Description |
| ---: | --- | :--- | ---: | :--- |
| 1 | **hashes** | exp:Hashes | 1 | Hash values displayed as hex |
| 2 | **ipv4_addr_s** | exp:IPv4-String | 1 | IPv4 address displayed as type-specific string (dotted-decimal): '192.168.0.254' |
| 3 | **ipv4_addr_x** | exp:IPv4-Hex | 1 | IPv4 address displayed as hex: 'C0A800FE' |
| 4 | **ipv4_addr_b64** | exp:IPv4-Base64url | 1 | IPv4 address displayed as Base64-url: 'wKgA_g' |
| 5 | **ipv6_addr_s** | exp:IPv6-String | 1 | IPv6 address displayed as type-specific string (colon-hex): '' |
| 6 | **ipv6_addr_x** | exp:IPv6-Hex | 1 | IPv6 address displayed as hex: '' |
| 7 | **ipv6_addr_b64** | exp:IPv6-Base64url | 1 | IPv6 address displayed as Base64-url: '' |
| 8 | **ipv4_net** | exp:IPv4-Net | 1 | IPv4 Network CIDR string |
| 9 | **ipv6_net** | exp:IPv6-Net | 1 | IPv6 Network CIDR string |

**_Type: exp:Hashes (Map)_**

| ID | Name | Type | # | Description |
| ---: | --- | :--- | ---: | :--- |
| 1 | **md5** | exp:Bin-128 | 0..1 | MD5 hash as defined in RFC3121 |
| 4 | **sha1** | exp:Bin-160 | 0..1 | SHA1 hash as defined in RFC3174 |
| 6 | **sha256** | exp:Bin-256 | 0..1 | SHA256 as defined in RFC6234 |

**_Type: exp:Bin-128_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:Bin-128 | Binary.x [16..16] | 128 bit value, hex display |

**_Type: exp:Bin-160_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:Bin-160 | Binary.x [20..20] | 160 bit value, hex display |

**_Type: exp:Bin-256_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:Bin-256 | Binary.x [32..32] | 256 bit value, hex display |

**_Type: exp:IPv4-Hex_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:IPv4-Hex | Binary.x [4..4] | Value must be 32 bits [4..4].  Value displayed in hex (Binary.x) |

**_Type: exp:IPv4-Base64url_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:IPv4-Base64url | Binary [4..4] | Value must be 32 bits [4..4].  Value displayed in base64url (Binary) default |

**_Type: exp:IPv4-String_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:IPv4-String | Binary.s:ipv4 [4..4] | Value must be 32 bits [4..4].  Value displayed in ipv4 dotted-decimal (Binary.s:ipv4) |

**_Type: exp:IPv6-Hex_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:IPv6-Hex | Binary.x [16..16] | Value must be 128 bits [16..16].  Value displayed in hex (Binary.x) |

**_Type: exp:IPv6-Base64url_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:IPv6-Base64url | Binary [16..16] | Value must be 128 bits [16..16].  Value displayed in base64url (Binary) default |

**_Type: exp:IPv6-String_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:IPv6-String | Binary.s:ipv6 [16..16] | Value must be 128 bits [16..16].  Value displayed in ipv6 colon-hex (Binary.s:ipv6) |

**_Type: exp:IPv4-Net (Array.s:ipv4-net)_**
...
**_Type: exp:IPv6-Net (Array.s:ipv6-net)_**
...
| 42 | **battery** | exp:Battery-Properties | 0..1 | Set of custom properties defined for an energy storage device |
...
**_Type: exp:Battery-Properties (Map)_**

| ID | Name | Type | # | Description |
| ---: | --- | :--- | ---: | :--- |
| 7 | **voltage** | Integer | 0..1 | Battery output voltage (millivolts) |
| 18 | **charge** | exp:Percentage | 0..1 | State of charge (percent) |
| 26 | **model** | String | 0..1 | Product name for this device |

**_Type: exp:Percentage_**

| Type Name | Base Type | Description |
| :--- | :--- | :--- |
| exp:Percentage | Number [0..100] | Real number in the range 0.0-100.0 |
