<!-- Generated from schema\oc2ls-csdpr02-slpf_merged.jadn, Mon Mar 18 17:59:50 2019-->
## Schema
| . | . |
| ---: | :--- |
...
| 6 | **versions** | Version | 0..* | Supported OpenC2 Language versions |
...
| :--- | :--- | :--- |
| **Features** | ArrayOf(Feature) [0..1] | A target used to query Actuator for its supported capabilities |
...
| 2 | Target.* | 1..* | **targets** - List of targets applicable to this action |
...
| 2 | **types** | jadn:Type | 1..* | Types defined in this schema module |
...
| 5 | **imports** | jadn:Import | 0..* | Imported schema modules |
| 6 | **exports** | jadn:Identifier | 0..* | Data types exported by this module |
...
| 5 | jadn:JADN-Type | 0..* | **fields** - List of fields for compound types.  Not present for primitive types |
